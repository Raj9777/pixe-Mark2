      ...
      <div className="legal-body">
        ...
        <div className="legal-section" id="pp-1">
          ...
          <div className="legal-highlight">
            ...
            <strong>Email:</strong> <a href="mailto:hello@pixe.dev">hello@pixe.dev</a><br />
        ...
        <div className="legal-section" id="pp-8">
          ...
          <div className="legal-highlight">
            To exercise any of these rights, contact us at <a href="mailto:hello@pixe.dev">hello@pixe.dev</a>.
        ...
        <div className="legal-section" id="pp-11">
          ...
          <p>
            ...
            from a minor, please contact us immediately at <a href="mailto:hello@pixe.dev">hello@pixe.dev</a> and
